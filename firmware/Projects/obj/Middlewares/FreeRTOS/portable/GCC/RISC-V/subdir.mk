...
C_SRCS += \
F:/claudecode/Luminode\ _\ Design\ System/ÖÇ»ÛÂ·µÆ/Middlewares/FreeRTOS/portable/GCC/RISC-V/port.c 

S_UPPER_SRCS += \
F:/claudecode/Luminode\ _\ Design\ System/ÖÇ»ÛÂ·µÆ/Middlewares/FreeRTOS/portable/GCC/RISC-V/portASM.S 
...
Middlewares/FreeRTOS/portable/GCC/RISC-V/port.o: F:/claudecode/Luminode\ _\ Design\ System/ÖÇ»ÛÂ·µÆ/Middlewares/FreeRTOS/portable/GCC/RISC-V/port.c
	...
	@	@
Middlewares/FreeRTOS/portable/GCC/RISC-V/portASM.o: F:/claudecode/Luminode\ _\ Design\ System/ÖÇ»ÛÂ·µÆ/Middlewares/FreeRTOS/portable/GCC/RISC-V/portASM.S
	@	@	riscv-none-embed-gcc -march=rv32imacxw -mabi=ilp32 -msmall-data-limit=8 -msave-restore -Os -fmessage-length=0 -fsigned-char -ffunction-sections -fdata-sections -fno-common -Wunused -Wuninitialized  -g -x assembler-with-cpp -I"F:\claudecode\Luminode _ Design System\ÖÇ»ÛÂ·µÆ\Middlewares\FreeRTOS" -I"F:\claudecode\Luminode _ Design System\ÖÇ»ÛÂ·µÆ\Middlewares\FreeRTOS\include" -I"F:\claudecode\Luminode _ Design System\ÖÇ»ÛÂ·µÆ\Middlewares\FreeRTOS\portable\GCC\RISC-V" -I"F:\claudecode\Luminode _ Design System\ÖÇ»ÛÂ·µÆ\Middlewares\FreeRTOS\portable\GCC\RISC-V\chip_specific_extensions\RV32I_PFIC_no_extensions" -I"F:\claudecode\Luminode _ Design System\ÖÇ»ÛÂ·µÆ\Middlewares\FreeRTOS\portable\MemMang" -MMD -MP -MF"$(@:%.o=%.d)" -MT"$(@)" -c -o "$@" "$<"
	@	@
